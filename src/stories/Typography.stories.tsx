...
export const Heading1: ComponentStory<typeof _Heading1> = () => (
  <_Heading1>{heading}</_Heading1>
)

export const Heading2: ComponentStory<typeof _Heading2> = () => (
  <_Heading2>{heading}</_Heading2>
)

export const Heading3: ComponentStory<typeof _Heading3> = () => (
  <_Heading3>{heading}</_Heading3>
)

export const Heading4: ComponentStory<typeof _Heading4> = () => (
  <_Heading4>{heading}</_Heading4>
)

export const Heading6: ComponentStory<typeof _Heading6> = () => (
  <_Heading6>{heading}</_Heading6>
)

export const Body1: ComponentStory<typeof _Body1> = () => (
  <_Body1>{body}</_Body1>
)

export const Body2: ComponentStory<typeof _Body2> = () => (
  <_Body2>{body}</_Body2>
)

export const Body3: ComponentStory<typeof _Body3> = () => (
  <_Body3>{body}</_Body3>
)
...
export const Caption1: ComponentStory<typeof _Caption1> = () => (
  <_Caption1>{caption}</_Caption1>
)

export const Caption2: ComponentStory<typeof _Caption2> = () => (
  <_Caption2>{caption}</_Caption2>
)
