...
var NoDocs = function NoDocs2() {
  return /* @__PURE__ */ React__default__default.createElement("div", {
    ...
    style: main
  }, /* @__PURE__ */ React__default__default.createElement("h1", {
    style: heading
  }, "No Docs"), /* @__PURE__ */ React__default__default.createElement("p", null, "Sorry, but there are no docs for the selected story. To add them, set the story's\xA0", /* @__PURE__ */ React__default__default.createElement("code", null, "docs"), " parameter. If you think this is an error:"), /* @__PURE__ */ React__default__default.createElement("ul", null, /* @__PURE__ */ React__default__default.createElement("li", null, "Please check the story definition."), /* @__PURE__ */ React__default__default.createElement("li", null, "Please check the Storybook config."), /* @__PURE__ */ React__default__default.createElement("li", null, "Try reloading the page.")), /* @__PURE__ */ React__default__default.createElement("p", null, "If the problem persists, check the browser console, or the terminal you've run Storybook from.")));
};
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 20:
            Page = _context.t2;
            docsElement = /* @__PURE__ */ React__default__default.createElement(DocsContainer, {
              key: story.componentId,
              context: docsContext
            }, /* @__PURE__ */ React__default__default.createElement(Page, null));
            _context.next = 24;
...
//# sourceMappingURL=renderDocs.js.map
