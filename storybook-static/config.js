import { m as mapValues_1, c as commonjsGlobal, a as combineParameters, d as dedent, g as getAugmentedNamespace, _ as _baseGetTag, i as isArray_1, b as isObjectLike_1, e as isPlainObject_1, f as isFunction_1, h as addons, u as useEffect, l as logger, j as browser } from "./iframe.js";
import * as React__default from "react";
import React__default__default, { Fragment, isValidElement, createElement } from "react";
import { s as str } from "./string.js";
import { j as jsx$1 } from "./jsx-runtime.js";
var convertSig$1 = function convertSig(type) {
  switch (type.type) {
    case "function":
      return {
        name: "function"
...
var convert$3 = function convert(type) {
...
var convertSig2 = function convertSig3(type) {
  switch (type.type) {
    case "function":
      return {
        name: "function"
...
var convert$2 = function convert2(type) {
  var name2 = type.name, raw = type.raw;
  var base2 = {};
  if (typeof raw !== "undefined")
    base2.raw = raw;
...
var QUOTE_REGEX = /^['"]|['"]$/g;
var trimQuotes = function trimQuotes2(str2) {
  return str2.replace(QUOTE_REGEX, "");
};
var includesQuotes = function includesQuotes2(str2) {
  return QUOTE_REGEX.test(str2);
};
var SIGNATURE_REGEXP = /^\(.*\) => /;
var convert$1 = function convert3(type) {
...
var convert4 = function convert5(docgenInfo) {
...
util$6.inherits(assert.AssertionError, Error);
...
function inspect(something) {
  if (functionsHaveNames || !util$6.isFunction(something)) {
    return util$6.inspect(something);
  }
...
function _deepEqual(actual, expected, strict2, memos) {
  ...
  } else if (util$6.isDate(actual) && util$6.isDate(expected)) {
    return actual.getTime() === expected.getTime();
  } else if (util$6.isRegExp(actual) && util$6.isRegExp(expected)) {
...
function objEquiv(a, b2, strict2, actualVisitedObjects) {
  if (a === null || a === void 0 || b2 === null || b2 === void 0)
    return false;
  if (util$6.isPrimitive(a) || util$6.isPrimitive(b2))
    return a === b2;
...
function _throws(shouldThrow, block, expected, message) {
  ...
  var isUnwantedException = !shouldThrow && util$6.isError(actual);
    ...
    (function(exports2) {
      ...
      TagParser.prototype.parseCaption = function parseDescription() {
        ...
        if (captionStart >= 0 && captionEnd >= 0) {
          this._tag.caption = description2.substring(captionStart + captionStartTag.length, captionEnd).trim();
...
function IndexedSourceMapConsumer(aSourceMap, aSourceMapURL) {
  ...
  this._sections = sections.map(function(s) {
    ...
    var offset2 = util$1.getArg(s, "offset");
...
(function(exports) {
  (function() {
    var Syntax, Precedence, BinaryPrecedence, SourceNode2, estraverse$1, esutils, base2, indent, json, renumber, hexadecimal, quotes, escapeless, newline, space, parentheses, semicolons, safeConcatenation, directive, extra, parse4, sourceMap$1, sourceCode, preserveBlankLines, FORMAT_MINIFY, FORMAT_DEFAULTS;
...
var acorn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  Node,
  Parser,
  Position,
...
function safeSortObject(value, seen2) {
  ...
  if (value instanceof Date || value instanceof RegExp || /* @__PURE__ */ React__default.isValidElement(value)) {
    return value;
  }
  seen2.add(value);
...
var parseReactElement = function parseReactElement2(element, options) {
  ...
  } else if (!/* @__PURE__ */ React__default__default.isValidElement(element)) {
  ...
  var childrens = React__default__default.Children.toArray(element.props.children).filter(onlyMeaningfulChildren).map(function(child) {
...
var renderJsx = function renderJsx2(code2, options) {
  ...
  for (var i = 0; i < options.skip; i += 1) {
    ...
    if (React__default__default.Children.count(renderedJSX) > 1) {
  ...
  var result = React__default__default.Children.map(code2, function(c2) {
