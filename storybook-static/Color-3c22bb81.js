import { s as styled, W as WithTooltip, T as TooltipNote, F as Form, I as Icons, B as getControlId, a as __rest, C as _root, D as isObject_1, E as isSymbol_1 } from "./index2.js";
import React__default__default, { useRef, useMemo, useEffect, useState, useCallback, useLayoutEffect } from "react";
import "./iframe.js";
...
var s = function s2(e, r, t) {
...
}, m = React__default__default.memo(function(o) {
  var a = o.onMove, l = o.onKey, s3 = c(o, ["onMove", "onKey"]), m2 = useRef(null), g3 = i(a), p3 = i(l), b3 = useRef(null), _2 = useRef(false), x3 = useMemo(function() {
    ...
    return [function(e2) {
      ...
      r2 < 37 || r2 > 40 || (e2.preventDefault(), p3({
        left: r2 === 39 ? 0.05 : r2 === 37 ? -0.05 : 0,
        top: r2 === 40 ? 0.05 : r2 === 38 ? -0.05 : 0
      }));
    }, t];
  ...
  var t = r.color, n = r.left, o = r.top, a = o === void 0 ? 0.5 : o, l = g(["react-colorful__pointer", r.className]);
  ...
  return r === void 0 && (r = "deg"), Number(e) * (_[r] || 1);
}, E = function E2(e) {
...
}, K = React__default__default.memo(function(r) {
  var t = r.hue, n = r.onChange, o = g(["react-colorful__hue", r.className]);
  return /* @__PURE__ */ jsx("div", {
    className: o,
    children: React__default__default.createElement(m, {
      ...
      "aria-label": "Hue",
      "aria-valuetext": b(t)
    }, React__default__default.createElement(p, {
...
}), L = React__default__default.memo(function(r) {
...
function T(e, t, l) {
  ...
  var d3 = useCallback(function(e2) {
    f3(function(r) {
...
var P = typeof window != "undefined" ? useLayoutEffect : useEffect, X = function X2() {
  return typeof __webpack_nonce__ != "undefined" ? __webpack_nonce__ : void 0;
}, R = /* @__PURE__ */ new Map(), V = function V2(e) {
  P(function() {
  ...
  var n = t.className, o = t.colorModel, a = t.color, l = a === void 0 ? o.defaultColor : a, i2 = t.onChange, s3 = c(t, ["className", "colorModel", "color", "onChange"]), f3 = useRef(null);
  V(f3);
  ...
  return React__default__default.createElement($, u({}, r, {
    colorModel: G
  }));
}, Q = function Q2(r) {
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsx("div", {
      ...
      style: a
    }), React__default__default.createElement(m, {
      onMove: function onMove(e) {
        o({
          a: e.left
        });
...
var useColorInput = function useColorInput2(initialValue, onChange) {
  var _useState = useState(initialValue || ""), _useState2 = _slicedToArray(_useState, 2), value = _useState2[0], setValue = _useState2[1];
  var _useState3 = useState(function() {
    return parseValue(value);
  }), _useState4 = _slicedToArray(_useState3, 2), color = _useState4[0], setColor = _useState4[1];
  var _useState5 = useState((color === null || color === void 0 ? void 0 : color.colorSpace) || ColorSpace.HEX), _useState6 = _slicedToArray(_useState5, 2), colorSpace = _useState6[0], setColorSpace = _useState6[1];
  useEffect(function() {
...
var usePresets = function usePresets2(presetColors, currentColor, colorSpace) {
  var _useState7 = useState((currentColor === null || currentColor === void 0 ? void 0 : currentColor.valid) ? [currentColor] : []), _useState8 = _slicedToArray(_useState7, 2), selectedColors = _useState8[0], setSelectedColors = _useState8[1];
  useEffect(function() {
...
//# sourceMappingURL=Color-3c22bb81.js.map
